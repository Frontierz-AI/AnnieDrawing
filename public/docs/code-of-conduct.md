...
Report conduct concerns privately to a project maintainer through an existing verified contact channel. The release checklist requires a verified private community contact before public launch. If no safe project channel exists, use the hosting platform's reporting tools. This document applies to project spaces and to people representing the project publicly.
