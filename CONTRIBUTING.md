...
Thank you for helping make drawing feel natural. Read [AGENTS.md](AGENTS.md), run the demo, and keep changes focused on one understandable improvement.
...
Follow the [code of conduct](CODE_OF_CONDUCT.md). Share minimal reproductions without secrets or private drawings. Report security concerns using [SECURITY.md](SECURITY.md) instead of posting an exploit and sensitive data publicly.
